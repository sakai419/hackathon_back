...
// GetReportedUsersParams defines parameters for GetReportedUsers.
type GetReportedUsersParams struct {
...
// GetReportedUsers operation middleware
func (siw *ServerInterfaceWrapper) GetReportedUsers(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params GetReportedUsersParams
